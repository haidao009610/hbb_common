...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("NccDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://nccdesk.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://nccdesk.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/nccdesk/nccdesk/wiki/Headless-Linux-Support";

lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("nccdesk docs home", LINK_DOCS_HOME),
        ("nccdesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("nccdesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RS_PUB_KEY: &str = "YXDZnccstar03549494";
